...
export class first1642621205750 implements MigrationInterface {
    name = 'first1642621205750'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`INSERT INTO "user" (name, login, password) VALUES ('admin', 'admin', '${await generateHash("admin")}')`)
    }
